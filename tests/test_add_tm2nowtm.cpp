...
SECTION("adding days", "[days day_of_week day_of_year]"){
  ...
  SECTION(""){    
    ...
    SECTION("first day of month +0 days"){
      ...
      tm2.tm_mday = 0;  //we adding 0-days 

      tm3 = add_tm2tm(tm1, tm2);
      REQUIRE(tm3.tm_mday == 0); //w/o change
      REQUIRE(tm3.tm_mon == 0);  //w/o change
      //we adding 0 days to 1 day of year      
    ...
    SECTION("day 0 (1-st of month) + one day"){
      ...
      tm2.tm_mday = 1;  //we adding one day
    ...
    SECTION("day 1 + 31 days"){      
      ...
      tm2.tm_mday = 31;  //we adding all day of current month

      tm3 = add_tm2tm(tm1, tm2);
      REQUIRE(tm3.tm_mday == 1); //first day of next month
      REQUIRE(tm3.tm_mon == 2);  //February
      REQUIRE(tm3.tm_yday == 31); //31 of January + 
      REQUIRE(tm3.tm_wday == tm1.tm_wday + 31 % 7); //tuesday - one day after
    };    
    ...
    SECTION("non-transitional february day 28+ one day"){     
      tm1.tm_mon = 2; //February
      tm2.tm_isdst = 0; //28days
    ...
    SECTION("transitional february day 29+ one day"){     
      ...
      REQUIRE(tm3.tm_wday == tm1.tm_wday + 29 % 7); 
      REQUIRE(tm3.tm_isdst == 1); 
    };
    SECTION("march day 30+ one day"){     
      ...
      tm3 = add_tm2tm(tm1, tm2);
      REQUIRE(tm3.tm_mday == 1); //first day of next month
      REQUIRE(tm3.tm_mon == 4);  
      REQUIRE(tm3.tm_yday == 0+31+28+30); //31 of January + 
      REQUIRE(tm3.tm_wday == tm1.tm_wday + 30 % 7); //tuesday - one day after
    };    
